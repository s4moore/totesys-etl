...
class TestGetData:
    ...
    def test_log_with_total_number_of_files_extrcated(self,caplog,mock_s3_bucket):
        with caplog.at_level(logging.INFO):
            get_data(mock_s3_bucket)
    ...
    def test_logs_error(self,caplog):
        ...
        expected_error = botocore.exceptions.ClientError(expected_error_messsage,"ListObjectsV2")
